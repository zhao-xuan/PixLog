...
var platformGuides = map[string]Guide{
	...
	"comfyui": {
		...
		Summary:         "Capture workflow submissions before execution and map prompt IDs to output artifacts.",
		Steps: []string{
			...
			"Keep workflow model paths stable; PixLog records the request and output mapping but cannot make nondeterministic kernels exact.",
		},
		VerificationCommand: "pixlog capture status",
	},
	"automatic1111": {
